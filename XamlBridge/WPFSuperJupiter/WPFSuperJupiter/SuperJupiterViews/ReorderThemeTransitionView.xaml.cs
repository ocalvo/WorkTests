...
{
    public sealed partial class ReorderThemeTransitionView : Page
    {

        Random rand = new Random(1000); // use a specific seed to keep it deterministic

        public ReorderThemeTransitionView()
        {
        ...
        private void RemoveButton_Click(object sender, RoutedEventArgs e)
        {
            if (ItemsList.Items.Count > 0)
            {
                ...
                int idx = rand.Next(0, ItemsList.Items.Count);
