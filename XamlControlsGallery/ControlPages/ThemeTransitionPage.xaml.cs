...
namespace AppUIBasics.ControlPages
{
    ...
    public sealed partial class ThemeTransitionPage : Page
    {
        ...
        private void EntranceAddButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                EntranceStackPanel.Children.Add(new Rectangle() { Width = 50, Height = 50, Margin = new Thickness { Left = 5.0, Right = 5.0, Top = 5.0, Bottom = 5.0 }, Fill = new SolidColorBrush(Windows.UI.Colors.LightBlue) });
            }
        }
